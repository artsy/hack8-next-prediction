...
export const GavelIcon = (props: { fill: string }) => (
  <GavelContainer fill={props.fill}>
    ...
    >
      <g>
        <rect x={8.572} y={13.5} transform="matrix(0.4541 -0.891 0.891 0.4541 -6.8465 20.8261)" width={10} height={5}/>
        <rect x={16.308} y={18.179} transform="matrix(0.891 0.4541 -0.4541 0.891 10.8683 -6.903)" width={7.001} height={1.999}/>
      </g>
    </svg>
  </GavelContainer>
)
